...
describe("Persistent Node Chat Server", function() {
  ...
  it("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
             ...
             json: {username: "Valjean",
                    message: "In mercy name, three days is all I need.",
                    roomname: "Hello"}
            },
            function () {
              ...
              var queryString = 'select message from messagesTable';
              // var queryArgs = [];
              ...
              dbConnection.query( queryString,
                function(err, results) {
                  ...
                  expect(results[0].message).to.equal("In mercy name, three days is all I need.");
  ...
  it("Should output all messages from the DB", function(done) {
    ...
    var queryString = "INSERT INTO messagesTable (message) VALUES ('Men like you can never change!')";
    //var queryArgs = [];
